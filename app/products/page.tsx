...
export default async function Page() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="mb-32 grid text-center lg:mb-0 lg:gird-cols-4 lg:text-left md:gap-10">
                  ...
                  {product.prices.map(price => {
                    ...
                    return (
                      <form
                        ...
                        <button 
                          type="submit"
                          className="bg-blue-500 hover:bg-blue-700 text-whiite font-bold py-2 px-4 rounded">Buy now</button>
                      </form>
                    )
                  })}
              </div>
